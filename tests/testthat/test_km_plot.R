...
operating_system <-    Sys.info()["sysname"]
  ...
  fig0 <- km_ggplot(fit)
  vdiffr::expect_doppelganger("basic", fig0, variant = operating_system )
  fig1 <- km_ggplot(fit, timeby = 500)
  vdiffr::expect_doppelganger("basic_more_ticks", fig1, variant = operating_system )
  ...
  fig5 <- km_ggplot(fit0)
  vdiffr::expect_doppelganger("single", fig5, variant = operating_system )
  ...
  vdiffr::expect_doppelganger("strata", fig6, variant = operating_system )
