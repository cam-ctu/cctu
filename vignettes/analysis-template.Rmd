...
### Code Tree
The audit trail of code architecture is turned into a visual tree below. In real life you would want to use `render` to create a seperate pdf file (note this only works via latex->pdf and can't do word or html currently). You _may_ need to use
