...
#'  \code{signif} and \code{round}, but resulting in character representations
...
#' always round up.
#' @param format See \code{formatC}. Default is \code{"fg"}, change it to
#'  \code{"g"} if scientific is preferred.
