...
#'
#' This is a wrapper function of \code{stat_tab_old}, allowing for grouped variables,
...
#' @describeIn cttabold The default interface, where \code{x} is a \code{data.frame}.
#' @export
cttabold.default <- function(x,
                          data,
                          group = NULL,
                          row_split = NULL,
                          total = TRUE,
...
#' @describeIn cttabold The formula interface, where \code{x} is a \code{formula}.
#' @export
cttabold.formula <- function(x,
                          data,
                          total = TRUE,
                          select = NULL,
                          add_missing = TRUE,
...
.cttabold_internal <- function(
  ...
  # Blank cttabold matrix
  blnk_cttabold <- function(row_labs, pos, from_tab) {
...
#'
#'
#' @inheritParams cttabold
#'
#' @return An object of class "cttabold".
#'
#' @importFrom data.table .SD
#' @keywords internal

stat_tab_old <- function(vars,
                     group = NULL,
                     data,
                     total = TRUE,
                     select = NULL,
