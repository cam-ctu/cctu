...
write.csv(get_meta_table(), file="Output/meta_table.csv", row.names = FALSE)
write.csv(cctu:::cctu_env$code_tree, file="Output/codetree.csv", row.names = FALSE)
...
The output is [Output/Reports/Vignette_Report.doc](Output/Reports/Vignette_Report.doc).  To permanently save, first go to file > Edit Links to Files;  highlight all the figures (shift + scroll), and click "break link". Then File> save as,  and esnure it is Saved As Type a "Word Document (*.docx)".
