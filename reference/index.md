...
- [`gitignore_init()`](https://cam-ctu.github.io/cctu/reference/gitignore_init.md)
  : checks to see if a .gitignore needs to be create or edited based on
  the template file
...
- [`gitcheck()`](https://cam-ctu.github.io/cctu/reference/gitcheck.md) :
