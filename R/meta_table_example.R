...
#'  \item{subtitle}{optional subtitle values. Use the empty string if no subtitle wanted.}
#'  \item{number}{the tem number, to use for link up with \code{\link{attach_pop}}, \code{\link{write_table}}, \code{\link{write_ggplot}}.}
#'  \item{population}{the name of the population to use for the item. See \code{\link{create_popn_envir}}.}
#'  \item{orientation}{takes values "portrait" or "landscape" to determine the page orientation for each item}
#'  \item{margin}{takes values "normal" or "narrow" to determine the page margin for each item}
...
#'
#'
#'This is an example of the structure of a meta_table that must exist internally to use \code{\link{attach_pop},\link{write_table}, \link{write_ggplot},\link{create_word_xml}}.
#'All variables are characters, including 'number'. The variables 'orientation' and 'item' can only take specific values.
#'
...
#'
#'Then you must set it internally using  \code{\link{set_meta_table}}, and possible examine the contents with \code{\link{get_meta_table}}
#'
